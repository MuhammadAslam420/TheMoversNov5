...
/*configuration*/
        ...
        Route::prefix('seatbyseat/price')->group(function () {
            Route::get('/', 'SeatPriceController@index')->name('seat_price.index');
            Route::get('seat_prices/create', 'SeatPriceController@create')->name('seat_price.create');
            Route::post('seat_prices', 'SeatPriceController@store')->name('seat_price.store');
            Route::get('seat_prices/{seatPrice}/edit', 'SeatPriceController@edit')->name('seat_price.edit');
            Route::put('seat_prices/{seatPrice}', 'SeatPriceController@update')->name('seat_price.update');
            Route::delete('seat_prices/{seatPrice}', 'SeatPriceController@destroy')->name('seat_price.destroy');
