...
<!--          @if(auth()->user()->can('view-email-templates'))
          ...
          @endif  -->
          @if(auth()->user()->can('view-seatbyseat-price'))
          <li class="{{ 'seatbyseat_price' == $sub_menu ? 'active' : '' }}">
            <a href="{{url('/seatbyseat/price')}}"><i class="fa fa-circle-thin"></i>@lang('pages_names.seatbyseat_price')</a>
          </li>
          @endif
        </ul>
      </li>
